...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Conquer Nation moves freight across North America with precision: fulfillment, transloading, warehousing, drayage, transportation, and 3PL." },
      { property: "og:title", content: "Conquer Nation Logistics" },
      { property: "og:description", content: "Futuristic logistics, human service. Get a quote in minutes." },
